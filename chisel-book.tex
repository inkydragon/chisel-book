...
and how to describe them in Chisel,
switching to another language takes a few days.
...
We will present the SystemVerilog examples together with the Chisel version
of the code.
...
Listing~\ref{lst:sv:ch:adder} shows the same component in Chisel.
...
Lipsi instruction set simulator in Scala for co-simulaevaluated from left to right.tion, and write a few test cases
in Lipsi assembler.
